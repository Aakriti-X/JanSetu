...
if __name__ == "__main__":
    import uvicorn
    print(f"\n  SIH25231 RAG API  ->  https://localhost:{API_PORT}")
    print(f"  Interactive docs  ->  https://localhost:{API_PORT}/docs\n")
    uvicorn.run("api:app", host=API_HOST, port=API_PORT, reload=True, ssl_keyfile="key.pem", ssl_certfile="cert.pem")
